...
public class RedFar extends CommandOpMode {
    ...
    public void initialize() {
        ...
        x21 = new DriveDistanceX(s_drive, -20);
        y11 = new DriveDistanceY(s_drive,40);
        y21 = new DriveDistanceY(s_drive,10.5);
        y31 = new DriveDistanceY(s_drive, -83.5);
        ...
        x22 = new DriveDistanceX(s_drive, 6                                                                                                                                            );
        x32 = new DriveDistanceX(s_drive, -15);
        y22 = new DriveDistanceY(s_drive,32);
        y32 = new DriveDistanceY(s_drive, 17);
        y42 = new DriveDistanceY(s_drive,-88 );
        ...
        x13 = new DriveDistanceX(s_drive, -28);
