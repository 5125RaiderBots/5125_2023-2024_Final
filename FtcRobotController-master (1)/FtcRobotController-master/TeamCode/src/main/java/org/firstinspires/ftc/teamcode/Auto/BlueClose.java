...
public class BlueClose extends CommandOpMode {
    ...
    public void initialize() {
        ...
        x11 = new DriveDistanceX(s_drive, -3);
        y11 = new DriveDistanceY(s_drive,42);
        y21 = new DriveDistanceY(s_drive,-18);
        y31 = new DriveDistanceY(s_drive, -38);
        y41 = new DriveDistanceY(s_drive,5);
        y51 = new DriveDistanceY(s_drive,-22);
        rx11 = new TurnToAngle(s_drive,-90);
        rx21 = new TurnToAngle(s_drive,0.0000000000001);
        rx31 = new TurnToAngle(s_drive,-0.0000000000001);
        ...
        x22 = new DriveDistanceX(s_drive,12);
        y12 = new DriveDistanceY(s_drive,30);
        y22 = new DriveDistanceY(s_drive,-31);
        y32 = new DriveDistanceY(s_drive, -29);
        y42 = new DriveDistanceY(s_drive,5);
        y52 = new DriveDistanceY(s_drive,-18   );
        rx12 = new TurnToAngle(s_drive,-90);
        rx22 = new TurnToAngle(s_drive,0.000000000001);
        rx32 = new TurnToAngle(s_drive,-0.000000000001);
        ...
        x13 = new DriveDistanceX(s_drive, -8);
        ...
        y53 = new DriveDistanceY(s_drive, -30);
        rx13 = new TurnToAngle(s_drive,-90);
        rx23 = new TurnToAngle(s_drive,0.0000001);
        rx33= new TurnToAngle(s_drive,-0.0000001);
        ...
        auto3 = new ParallelDeadlineGroup(
                ...
                new ParallelCommandGroup(close11, y11)/*,new WaitCommand(8000)*/,
                lifterUP1, drop3, new WaitCommand(100), y21, rx11, y31, x11,
                elbowScore1,
                new WaitCommand(500),
                open21,
                new WaitCommand(750),
        ...
        auto2 = new ParallelDeadlineGroup(
                ...
                new ParallelCommandGroup(close12, x12), y12, rx12,/*new WaitCommand(8000) ,*/ lifterUP2, new WaitCommand(100), drop2,new WaitCommand(100),  y22,  x22,
                elbowScore2,
                new WaitCommand(500),
                open22,
                new WaitCommand(750),
        ...
        auto1 = new ParallelDeadlineGroup(
                ...
                new ParallelCommandGroup(close13, y13), rx13, y23, /*new WaitCommand(8000),*/ lifterUP3,
                drop1, new WaitCommand(100), y33, x13,
        ...
        zone = new SelectCommand(
                new HashMap<Object, Command>() {{
                    put(Drive.Zone.LEFT, auto2);
                    put(Drive.Zone.RIGHT, auto1);
